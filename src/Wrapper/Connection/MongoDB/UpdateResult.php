 ...
 */
class UpdateResult implements ObjectInterface
{
    /**
    ...
    {
        return [
            'getMatchedCount' => [$this, 'getMatchedCount'],
            'getModifiedCount' => [$this, 'getModifiedCount'],
            'getUpsertedCount' => [$this, 'getUpsertedCount'],
            'getUpsertedId' => [$this, 'getUpsertedId'],
